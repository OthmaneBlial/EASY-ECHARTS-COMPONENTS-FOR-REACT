...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      seriesData: [
        [3463, 31898, 96, 10049, 34967, 15012, 1701],
  ...
  randomize = () => {
    this.setState({
      seriesData: this.state.seriesNames.map((seriesName, index) =>
        Array(7)
          .fill()
  ...
  onHideCode = type => {
    if (this.state.showCodeArr.includes(type)) {
      this.setState({
        showCodeArr: this.state.showCodeArr.filter(item => item !== type)
      });
    }
  };
      ...
      <div className="App">
        <div className="container is-fluid">
          ...
          <div className="columns">
            <div className="column is-12">
              <a
                className="button is-light randomize is-fullwidth"
                ...
                <div className="control-buttons">
                  {!this.state.showCodeArr.includes("lineCode") && (
                    <a
                      ...
                      onClick={() => this.onShowCode("lineCode")}
                    >
                      Show code
                    </a>
                  )}
                  {this.state.showCodeArr.includes("lineCode") && (
                    <a
                      ...
                      onClick={() => this.onHideCode("lineCode")}
                    >
                      Hide code
                    </a>
                  )}
              ...
              <div className="echarts-component">
                ...
                <div className="control-buttons">
                  {!this.state.showCodeArr.includes("lineStackCode") && (
                    <a
                      className="button is-dark is-large"
                      onClick={() => this.onShowCode("lineStackCode")}
                    >
                      Show code
                    </a>
                  )}
                  {this.state.showCodeArr.includes("lineStackCode") && (
                    <a
                      className="button is-light is-large"
                      onClick={() => this.onHideCode("lineStackCode")}
                    >
                      Hide code
                    </a>
                  )}
              ...
              <div className="echarts-component">
                ...
                <div className="control-buttons">
                  {!this.state.showCodeArr.includes("barCode") && (
                    <a
                      className="button is-dark is-large"
                      onClick={() => this.onShowCode("barCode")}
                    >
                      Show code
                    </a>
                  )}
                  {this.state.showCodeArr.includes("barCode") && (
                    <a
                      className="button is-light is-large"
                      onClick={() => this.onHideCode("barCode")}
                    >
                      Hide code
                    </a>
                  )}
              ...
              <div className="echarts-component">
                ...
                <div className="control-buttons">
                  {!this.state.showCodeArr.includes("barStackCode") && (
                    <a
                      className="button is-dark is-large"
                      onClick={() => this.onShowCode("barStackCode")}
                    >
                      Show code
                    </a>
                  )}
                  {this.state.showCodeArr.includes("barStackCode") && (
                    <a
                      className="button is-light is-large"
                      onClick={() => this.onHideCode("barStackCode")}
                    >
                      Hide code
                    </a>
                  )}
              ...
              <div className="echarts-component">
                ...
                <div className="control-buttons">
                  {!this.state.showCodeArr.includes("areaCode") && (
                    <a
                      className="button is-dark is-large"
                      onClick={() => this.onShowCode("areaCode")}
                    >
                      Show code
                    </a>
                  )}
                  {this.state.showCodeArr.includes("areaCode") && (
                    <a
                      className="button is-light is-large"
                      onClick={() => this.onHideCode("areaCode")}
                    >
                      Hide code
                    </a>
                  )}
              ...
              <div className="echarts-component">
                ...
                <div className="control-buttons">
                  {!this.state.showCodeArr.includes("areaStackCode") && (
                    <a
                      className="button is-dark is-large"
                      onClick={() => this.onShowCode("areaStackCode")}
                    >
                      Show code
                    </a>
                  )}
                  {this.state.showCodeArr.includes("areaStackCode") && (
                    <a
                      className="button is-light is-large"
                      onClick={() => this.onHideCode("areaStackCode")}
                    >
                      Hide code
                    </a>
                  )}
              ...
              <div className="echarts-component">
                ...
                <div className="control-buttons">
                  {!this.state.showCodeArr.includes("pieCode") && (
                    <a
                      className="button is-dark is-large"
                      onClick={() => this.onShowCode("pieCode")}
                    >
                      Show code
                    </a>
                  )}
                  {this.state.showCodeArr.includes("pieCode") && (
                    <a
                      className="button is-light is-large"
                      onClick={() => this.onHideCode("pieCode")}
                    >
                      Hide code
                    </a>
                  )}
              ...
              <div className="echarts-component">
                ...
                <div className="control-buttons">
                  {!this.state.showCodeArr.includes("pieDoughuntCode") && (
                    <a
                      className="button is-dark is-large"
                      onClick={() => this.onShowCode("pieDoughuntCode")}
                    >
                      Show code
                    </a>
                  )}
                  {this.state.showCodeArr.includes("pieDoughuntCode") && (
                    <a
                      className="button is-light is-large"
                      onClick={() => this.onHideCode("pieDoughuntCode")}
                    >
                      Hide code
                    </a>
                  )}
